...
public class ComplaintsControllerV2 {
    ...
    public ResponseEntity<?> addComplaint(@RequestBody PracticeComplaintsDTO practiceComplaintsDTO,
                                               @RequestHeader("Authorization") String authorizationHeader) {
        String token = authorizationHeader.replace("Bearer ", "" );
        complaintsService.saveComplaints(practiceComplaintsDTO, token);
