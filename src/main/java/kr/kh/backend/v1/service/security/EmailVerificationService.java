package kr.kh.backend.v1.service.security;

import kr.kh.backend.v1.domain.EmailVerification;
import kr.kh.backend.v1.domain.User;
import kr.kh.backend.v1.dto.EmailVerificationDTO;
import kr.kh.backend.v1.dto.PracticeComplaintsDTO;
import kr.kh.backend.v1.mapper.UserMapper;
import kr.kh.backend.v1.service.MailService;
